...
// Un singur fisier: logica pura + server. Testare locala: node test_logica.mts
...
// Pe Deno (Supabase) pornim serverul. In Node (teste locale) nu facem nimic.
// deno-lint-ignore no-explicit-any
if (typeof (globalThis as any).Deno !== 'undefined') (globalThis as any).Deno.serve(handler);
